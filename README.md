...
The square World canvas fills the window's available width, with controls above and inspection, measurements and plots below. Widen the window to see larger worlds more clearly; resizing preserves the current selection and history.
