...
The World canvas fills the window's available width and follows the world's proportions, with square cells, controls above and inspection, measurements and plots below. Widen the window to see larger worlds more clearly; resizing preserves the current selection and history. Wear-repair inspection also shows the last selected action (which may have failed), or “Not yet acted” for initial agents and newborns. This memory currently leaves action probabilities unchanged.
